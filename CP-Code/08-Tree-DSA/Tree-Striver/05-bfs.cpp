...
TreeNode *newNode(TreeNode *root){
    cout << ("Enter the data: ") << newline;
    int data; cin >> data;
    root = new TreeNode(data);
    if (data == -1) return NULL;
    cout << "Enter Left Child: " << data << newline;
    root -> left = newNode(root -> left);
    cout << "Enter Right Child: " << data << newline;
...
struct Answer{
    ...
    void Solve(){
        ...
        cout << ("levelOrderTraversal(BFS): ") << newline;
        b.bfs(root);
        /*
        OutPut:
