...
struct Answer{
    ...
    void Solve(int tc){
        ...
        auto is_valid = [&](int n, int mid, string s) -> bool {
        ...
        cout << (ans <= n? ans : 0) << nln;
        // ! Second Solution -> Easy solution.
        // string s; cin >> s;
        // map<char, int> cnt;
        // int low = 0, ans = INF;
        ...
        //         low++;
        //     }
        //     if (cnt.size() == 3) ans = min(ans, i - low + 1);
        // }
        // cout << (ans > 1e7? 0 : ans) << nln;
    }
};
/*/--------------------------------------------------------------------------/*/
