...
struct Answer{
    ...
    void Solve(int tc){
        ...
        // trace(a); 
        /*
            a : {(2, 00), (3, 10), (4, 01), (4, 00)}
            a : {(3, 01), (3, 01), (5, 01), (2, 10), (9, 10)}
            a : {(5, 11)}
            a : {(9, 11), (8, 01), (7, 10)}
            a : {(4, 01), (6, 01), (7, 01), (8, 00), (9, 01), (1, 00)}
            a : {(8, 00), (9, 10), (9, 11), (8, 11)}
        */
        // sort(all(a));
        // trace(a);
        /*
            a : {(2, 00), (3, 10), (4, 00), (4, 01)}
            a : {(2, 10), (3, 01), (3, 01), (5, 01), (9, 10)}
            a : {(5, 11)}
            a : {(7, 10), (8, 01), (9, 11)}
            a : {(1, 00), (4, 01), (6, 01), (7, 01), (8, 00), (9, 01)}
            a : {(8, 00), (8, 11), (9, 10), (9, 11)}
        */
        int a, b, c; a = b = c = INF;
        for (int i = 0; i < n; i++){
            if (input[i].second == "01"){
                a = min(input[i].first, a);
            }
            else if (input[i].second == "10"){
                b = min(input[i].first, b);
            }
            if (input[i].second == "11"){
                c = min(input[i].first, c);
            }
        }
        // trace(a, b, c);
        /*
            a : 4 |  b : 3 |  c : 1000000000
            a : 3 |  b : 2 |  c : 1000000000
            a : 1000000000 |  b : 1000000000 |  c : 5
            a : 8 |  b : 7 |  c : 9
            a : 4 |  b : 1000000000 |  c : 1000000000
            a : 1000000000 |  b : 9 |  c : 8
        */
        int ans = min(a + b, c);
        cout << (ans == INF? -1 : ans) << nln;
    }
};
/*/--------------------------------------------------------------------------/*/
