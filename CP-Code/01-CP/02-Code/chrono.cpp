...
//         // ...
// };
inline void secondFromChrono(){
    /*/ ~ second is an arithmatic-lile type.
        ~ sizeof(seconds) == 8.
        ~ it is triviall destructible.
        ...
        ~ This is all like long long and int64_t.
    /*/
    seconds a; // no initialization
    cout << a.count() << newline;
    seconds b{}; // Zero initialization
    cout << b.count() << newline;
    // seconds c = 3; // error : Not implicitly constructible from int.
    seconds c{3}; // valid /// okay: 3 seconds
    // printing the duration
    cout << c.count() << 's' << newline;
}

inline void startChrono(){
    cout << "A <chrono> Tutorial" << newline;
    cout << "\tIt's about Time." << newline;
    secondFromChrono();
}
/*/--------------------------------------------------------------------------/*/
/*/ ShAiDSk_Solve() Defination /*/
inline void ShAiDSk_Solve(){
    int t = 1; // cin >> t;
    while (t--) startChrono();
}
/*/ MainFunction() /*/
