...
struct Answer{
    ...
    void Solve(int tc){
        ...
        //     }
            ...
            //     okay = true;
            // }
            // if (cnt < 6 || cnt > 6) okay = false; // cout << "No" << nln;
            // else okay = true; // cout << "Yes" << nln;
        // }
        // else {
        //     // cout << "No" << nln;
        //     okay = false;
        // }
        if (s.size() != 8 || !is_uppercase(s.front()) || !is_uppercase(s.back())) okay = false;
        for (int i = 1; i < 7; i++){
            if (!is_digit(s[i])) okay = false;
        }
        if (s[1] == '0') okay = false;
