...
Observation:
    -> Understand a dp problem || 
        i. count the total number of ways.
        ii. When ever comes in try all possible, it is the sign of 
            dp approach or Recursion approach
        iii. 
*/

// Counting the number of distinct ways to reach destination
void reachN(int n){
}
struct Answer{
    int get(char c){
    ...
    void Solve(){
        // g++ 02-DP-lec-p1.cpp -o 01-DP-lec-p1.out; ./01-DP-lec-p1.out < in > out; cat cerr.txt; echo "Local Output"; cat out
        Help h;
        int n; cin >> n;
        // Learn how to write 1D Recurrence Relation.
