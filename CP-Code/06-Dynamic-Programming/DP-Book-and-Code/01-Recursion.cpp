...
struct Answer{
    ...
    void Solve(){
        // /mnt/c/Users/91956/OneDrive/Desktop/ShAiDSkCode/CP-Code/06-Dynamic-Programming/DP-Book-and-Code
        // g++ 01-Recursion.cpp -o 01-Recursion.out; echo "--------------------";  ./01-Recursion.out < in > out; cat cerr.txt; echo "--------------------"; echo -e "\nOutput"; cat out
        Help h;
        int n; cin >> n;
        trace(sum(n));
        cout << sum(n) << newline;
